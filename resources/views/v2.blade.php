...
<body>
    <!--  Fixed Top Navbar -->
    <nav class="navbar navbar-expand-lg navbar-dark fixed-top bg-dark bg-transparent">
        <!-- bg-transparent -->
        <a class="navbar-brand" href="#">Mix Diaries</a>
    ...
    <div class="wrapper">
        ...
        <div id="content">
            ...
            <nav class="navbar navbar-default" id="sidebar-main">
